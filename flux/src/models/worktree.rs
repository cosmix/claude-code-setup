...
pub struct Worktree {
    ...
    pub path: PathBuf,
    /// Git branch name (e.g., "flux/stage-1")
    pub branch: String,
...
impl Worktree {
    ...
    ///
    /// # Returns
    /// A branch name in the format "flux/{stage_id}"
...
mod tests {
    ...
    fn test_new_worktree() {
        ...
        let branch = "flux/stage-1".to_string();
    ...
    #[test]
    fn test_branch_name() {
        assert_eq!(Worktree::branch_name("stage-1"), "flux/stage-1");
        assert_eq!(Worktree::branch_name("my-stage"), "flux/my-stage");
    }
